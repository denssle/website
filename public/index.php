...
<html lang="de">
	<head>
		...
		<!-- Vorschaukarte in Messengern und sozialen Netzen. Das Bild ist 1200×630
		     ...
		     Erzeugt aus den Farben der Seite, die englische Fassung hat ihr
		     eigenes unter /en/. Die absoluten URLs müssen wie die
		     hreflang-Angaben mitgezogen werden, wenn die Seite auf eine eigene
		     Domain umzieht. -->
		...
		<meta
			property="og:image"
			content="https://enzlor.uber.space/vorschaubild.png"
		/>
		...
		<!-- Ein Bild für alle vier Seiten, deshalb liegt es im Wurzelverzeichnis
		     und die englische Fassung greift mit ../ darauf zu. -->
				...
				<li class="projekt">
					...
					<p class="verweise">
						<!-- Mit Schrägstrich, wie beim Festival: /houses antwortet sonst mit
						     308 auf /houses/ -->
						<a class="verweis verweis--haupt" href="/houses/">Zum Spiel</a>
						<a
							class="verweis"
		...
		<footer class="fuss">
			...
			<div class="fuss-zeile">
				...
				<!-- Nur Icons, keine Adressen: der Name des Ziels steckt im title für
				     ...
				     Person aus. -->
				<nav class="fuss-profile" aria-label="Profile anderswo">
					<a
