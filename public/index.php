...
<html lang="de">
	<head>
		...
		/>
		<!-- Vorschaukarte in Messengern und sozialen Netzen. Ohne og:image wird
		     eine reine Textkarte gezeigt – immer noch besser als die nackte URL.
		     Die absoluten URLs müssen wie die hreflang-Angaben mitgezogen werden,
	...
	<body>
		<!-- Icon-Vorrat: einmal definiert, per <use> an jedem GitHub-Verweis
		     eingesetzt. Quelle: Primer Octicons (mark-github). Inline statt als
		     Datei, damit die Seite ohne zusätzlichen Request auskommt. -->
		...
		<footer class="fuss">
			<p>
				<a class="fuss-verweis" href="https://github.com/denssle">
					<svg class="icon" aria-hidden="true" focusable="false">
						<use href="#icon-github" />
					</svg>
					github.com/denssle
